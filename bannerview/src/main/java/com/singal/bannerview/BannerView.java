...
import com.singal.bannerview.transformer.CustomTransformer;
...
public class BannerView<T> extends RelativeLayout{
    ...
    private boolean mIsOpenMZEffect;//是否开启魅族Banner效果
    private boolean mIsCanLoop;//是否可用轮播图片
    private LinearLayout mIndicatorContainer;//indicator容器
    private ArrayList<ImageView> mIndicators = new ArrayList<>();
    //mIndicatorRes[0] 未选中 mIndicatorRes[1]选中
    ...
    private int mMZModePadding = 0;//在模仿魅族模式下，由于前后显示了上下一个页面的部分，因此需要计算这部分的padding
